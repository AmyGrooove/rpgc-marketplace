//TODO перенести enums в файл типов

import { AVATAR_1, BOOTS, BOX, JACKET, RIFLE } from '../../../../theme/sources'

export enum orderTypes {
  sale = 'Sale',
  buy = 'Buy',
  exchange = 'Exchange',
  // salePlus упразднить(разобраться где используется)
  salePlus = 'Sale + Exchange',
}
